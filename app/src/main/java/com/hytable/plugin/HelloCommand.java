...
public class HelloCommand extends AbstractPlayerCommand {
	...
	public HelloCommand(String name, String description, boolean requiresConfirmation) {
		super(name, description, requiresConfirmation);
		//TODO Auto-generated constructor stub
	}

	@Override
	protected void execute(@Nonnull CommandContext arg0, @Nonnull Store<EntityStore> arg1,
